<root dataType="Struct" type="Duality.Resources.Scene" id="129723834">
  ...
  <serializeObj dataType="Array" type="Duality.GameObject[]" id="427169525">
    ...
    <item dataType="Struct" type="Duality.GameObject" id="2674585711">
        ...
        <_items dataType="Array" type="Duality.Component[]" id="1595198758">
          ...
          <item dataType="Struct" type="Duality.Components.Renderers.SpriteRenderer" id="21784983">
            ...
            <sharedMat dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Material]]">
              <contentPath dataType="String">Data\Oxford.Material.res</contentPath>
            </sharedMat>
          ...
          <item dataType="Struct" type="Duality.Components.Physics.RigidBody" id="1442394939">
            ...
            <shapes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.ShapeInfo]]" id="1260118795">
              <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="4059903606" length="4">
                <item dataType="Struct" type="Duality.Components.Physics.PolyShapeInfo" id="384878560">
                  <density dataType="Float">1</density>
                  <friction dataType="Float">0.3</friction>
                  <parent dataType="ObjectRef">1442394939</parent>
                  <restitution dataType="Float">0.3</restitution>
                  <sensor dataType="Bool">false</sensor>
                  <vertices dataType="Array" type="OpenTK.Vector2[]" id="3041659868">
                    <item dataType="Struct" type="OpenTK.Vector2">
                      <X dataType="Float">-50.82007</X>
                      <Y dataType="Float">-54.2938232</Y>
                    </item>
                    <item dataType="Struct" type="OpenTK.Vector2">
                      <X dataType="Float">49.1968536</X>
                      <Y dataType="Float">-53.6647949</Y>
                    </item>
                    <item dataType="Struct" type="OpenTK.Vector2">
                      <X dataType="Float">47.938797</X>
                      <Y dataType="Float">52.0134735</Y>
                    </item>
                    <item dataType="Struct" type="OpenTK.Vector2">
                      <X dataType="Float">-50.1910324</X>
                      <Y dataType="Float">54.5296326</Y>
                    </item>
                  </vertices>
                </item>
              </_items>
      ...
      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
      <name dataType="String">Oxford</name>
      <parent />
      <prefabLink />
    </item>
    ...
    <item dataType="Struct" type="Duality.GameObject" id="2856129003">
      <active dataType="Bool">true</active>
      <children />
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="1020427673">
        <_items dataType="Array" type="Duality.Component[]" id="1504828494">
          <item dataType="Struct" type="Duality.Components.Transform" id="921476639">
            <active dataType="Bool">true</active>
            <angle dataType="Float">0</angle>
            <angleAbs dataType="Float">0</angleAbs>
            <angleVel dataType="Float">0</angleVel>
            <angleVelAbs dataType="Float">0</angleVelAbs>
            <deriveAngle dataType="Bool">true</deriveAngle>
            <gameobj dataType="ObjectRef">2856129003</gameobj>
            <ignoreParent dataType="Bool">false</ignoreParent>
            <parentTransform />
            <pos dataType="Struct" type="OpenTK.Vector3">
              <X dataType="Float">320.21463</X>
              <Y dataType="Float">-299.447968</Y>
              <Z dataType="Float">0</Z>
            </pos>
            <posAbs dataType="Struct" type="OpenTK.Vector3">
              <X dataType="Float">320.21463</X>
          ...
          <item dataType="Struct" type="Duality.Components.Renderers.SpriteRenderer" id="203328275">
            <active dataType="Bool">true</active>
            <colorTint dataType="Struct" type="Duality.Drawing.ColorRgba">
              <A dataType="Byte">255</A>
              <B dataType="Byte">255</B>
          ...
          <item dataType="Struct" type="Duality.Components.Physics.RigidBody" id="1623938231">
            <active dataType="Bool">true</active>
            <angularDamp dataType="Float">0.3</angularDamp>
            <angularVel dataType="Float">0</angularVel>
            <bodyType dataType="Enum" type="Duality.Components.Physics.BodyType" name="Dynamic" value="1" />
            ...
            <revolutions dataType="Float">0</revolutions>
            <shapes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.ShapeInfo]]" id="3823457607">
              <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="3244301006" length="4">
                <item dataType="Struct" type="Duality.Components.Physics.PolyShapeInfo" id="557564880">
                  <density dataType="Float">1</density>
                  <friction dataType="Float">0.3</friction>
                  <parent dataType="ObjectRef">1623938231</parent>
                  <restitution dataType="Float">0.3</restitution>
                  <sensor dataType="Bool">false</sensor>
                  <vertices dataType="Array" type="OpenTK.Vector2[]" id="1840790204">
                    <item dataType="Struct" type="OpenTK.Vector2">
                      <X dataType="Float">-50.0732422</X>
                      <Y dataType="Float">-66.47562</Y>
                    </item>
                    <item dataType="Struct" type="OpenTK.Vector2">
                      <X dataType="Float">49.55435</X>
                      <Y dataType="Float">-66.47562</Y>
                    </item>
                    <item dataType="Struct" type="OpenTK.Vector2">
                      <X dataType="Float">49.55435</X>
                      <Y dataType="Float">65.04713</Y>
                    </item>
                    <item dataType="Struct" type="OpenTK.Vector2">
                      <X dataType="Float">-50.0732422</X>
                      <Y dataType="Float">65.04713</Y>
          ...
          <item dataType="Struct" type="QuietWell.Player" id="3614519996">
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">2856129003</gameobj>
          </item>
        </_items>
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="4110841472" surrogate="true">
        <header />
        <body>
          <keys dataType="Array" type="System.Type[]" id="3094514611">
            <item dataType="ObjectRef">809826144</item>
            <item dataType="ObjectRef">928388430</item>
            <item dataType="ObjectRef">3731969610</item>
            <item dataType="ObjectRef">3076783358</item>
          </keys>
          <values dataType="Array" type="Duality.Component[]" id="2175985848">
            <item dataType="ObjectRef">921476639</item>
            <item dataType="ObjectRef">203328275</item>
            <item dataType="ObjectRef">1623938231</item>
            <item dataType="ObjectRef">3614519996</item>
          </values>
        </body>
      </compMap>
      <compTransform dataType="ObjectRef">921476639</compTransform>
      <identifier dataType="Struct" type="System.Guid" surrogate="true">
        <header>
          <data dataType="Array" type="System.Byte[]" id="1446758361">4VbTHO5C90eBo/QpEZXP/Q==</data>
        </header>
        <body />
      </identifier>
      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
    ...
    <item dataType="Struct" type="Duality.GameObject" id="3255611388">
      <active dataType="Bool">true</active>
      <children />
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="1343099282">
        <_items dataType="Array" type="Duality.Component[]" id="3095729744" length="4">
          <item dataType="Struct" type="Duality.Components.Transform" id="1320959024">
            <active dataType="Bool">true</active>
            <angle dataType="Float">0</angle>
            <angleAbs dataType="Float">0</angleAbs>
            <angleVel dataType="Float">0</angleVel>
            <angleVelAbs dataType="Float">0</angleVelAbs>
            <deriveAngle dataType="Bool">true</deriveAngle>
            <gameobj dataType="ObjectRef">3255611388</gameobj>
            <ignoreParent dataType="Bool">false</ignoreParent>
            <parentTransform />
            <pos dataType="Struct" type="OpenTK.Vector3">
              <X dataType="Float">680.9701</X>
              <Y dataType="Float">-208.030869</Y>
              <Z dataType="Float">0</Z>
            </pos>
            <posAbs dataType="Struct" type="OpenTK.Vector3">
              <X dataType="Float">680.9701</X>
          ...
          <item dataType="Struct" type="Duality.Components.Renderers.SpriteRenderer" id="602810660">
            <active dataType="Bool">true</active>
            <colorTint dataType="Struct" type="Duality.Drawing.ColorRgba">
              <A dataType="Byte">255</A>
              <B dataType="Byte">255</B>
            ...
            <rectMode dataType="Enum" type="Duality.Components.Renderers.SpriteRenderer+UVMode" name="Stretch" value="0" />
            <sharedMat dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Material]]">
              <contentPath dataType="String">Data\Kombucha.Material.res</contentPath>
            </sharedMat>
            <visibilityGroup dataType="Enum" type="Duality.Drawing.VisibilityFlag" name="Group0" value="1" />
          </item>
          <item dataType="Struct" type="Duality.Components.Physics.RigidBody" id="2023420616">
            <active dataType="Bool">true</active>
            <angularDamp dataType="Float">0.3</angularDamp>
            <angularVel dataType="Float">0</angularVel>
            <bodyType dataType="Enum" type="Duality.Components.Physics.BodyType" name="Dynamic" value="1" />
            ...
            <revolutions dataType="Float">0</revolutions>
            <shapes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.ShapeInfo]]" id="302471736">
              <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="3670017644" length="4">
                <item dataType="Struct" type="Duality.Components.Physics.CircleShapeInfo" id="2573661028">
                  <density dataType="Float">1</density>
                  <friction dataType="Float">0.3</friction>
                  <parent dataType="ObjectRef">2023420616</parent>
                  <position dataType="Struct" type="OpenTK.Vector2">
                    <X dataType="Float">0</X>
                    <Y dataType="Float">0</Y>
                  </position>
                  <radius dataType="Float">34.73111</radius>
                  <restitution dataType="Float">0.3</restitution>
                  <sensor dataType="Bool">false</sensor>
                </item>
              </_items>
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="1023061962" surrogate="true">
        <header />
        <body>
          <keys dataType="Array" type="System.Type[]" id="2395596232">
            <item dataType="ObjectRef">809826144</item>
            <item dataType="ObjectRef">928388430</item>
            <item dataType="ObjectRef">3731969610</item>
          </keys>
          <values dataType="Array" type="Duality.Component[]" id="2936700638">
            <item dataType="ObjectRef">1320959024</item>
            <item dataType="ObjectRef">602810660</item>
            <item dataType="ObjectRef">2023420616</item>
          </values>
        </body>
      </compMap>
      <compTransform dataType="ObjectRef">1320959024</compTransform>
      <identifier dataType="Struct" type="System.Guid" surrogate="true">
        <header>
          <data dataType="Array" type="System.Byte[]" id="430271540">J+UfchP/9Eq/R098Yj2tLw==</data>
        </header>
        <body />
      </identifier>
      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
      <name dataType="String">Kombucha</name>
      <parent />
      <prefabLink />
    </item>
    <item dataType="Struct" type="Duality.GameObject" id="2710622207">
      <active dataType="Bool">true</active>
      <children />
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="4174543869">
        <_items dataType="Array" type="Duality.Component[]" id="1723981094">
          <item dataType="Struct" type="Duality.Components.Transform" id="775969843">
            <active dataType="Bool">true</active>
            <angle dataType="Float">0</angle>
            <angleAbs dataType="Float">0</angleAbs>
            <angleVel dataType="Float">0</angleVel>
            <angleVelAbs dataType="Float">0</angleVelAbs>
            <deriveAngle dataType="Bool">true</deriveAngle>
            <gameobj dataType="ObjectRef">2710622207</gameobj>
            <ignoreParent dataType="Bool">false</ignoreParent>
            <parentTransform />
            <pos dataType="Struct" type="OpenTK.Vector3">
              <X dataType="Float">479.5652</X>
              <Y dataType="Float">-326.1624</Y>
              <Z dataType="Float">0</Z>
            </pos>
            <posAbs dataType="Struct" type="OpenTK.Vector3">
              <X dataType="Float">479.5652</X>
          ...
          <item dataType="Struct" type="Duality.Components.Renderers.SpriteRenderer" id="57821479">
            <active dataType="Bool">true</active>
            <colorTint dataType="Struct" type="Duality.Drawing.ColorRgba">
              <A dataType="Byte">255</A>
              <B dataType="Byte">255</B>
            ...
            <rectMode dataType="Enum" type="Duality.Components.Renderers.SpriteRenderer+UVMode" name="Stretch" value="0" />
            <sharedMat dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Material]]">
              <contentPath dataType="String">Data\Taylor.Material.res</contentPath>
            </sharedMat>
            <visibilityGroup dataType="Enum" type="Duality.Drawing.VisibilityFlag" name="Group0" value="1" />
          </item>
          <item dataType="Struct" type="Duality.Components.Physics.RigidBody" id="1478431435">
            <active dataType="Bool">true</active>
            <angularDamp dataType="Float">0.3</angularDamp>
            <angularVel dataType="Float">0</angularVel>
            <bodyType dataType="Enum" type="Duality.Components.Physics.BodyType" name="Dynamic" value="1" />
            ...
            <revolutions dataType="Float">0</revolutions>
            <shapes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.ShapeInfo]]" id="353447963">
              <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="1861088918" length="4">
                <item dataType="Struct" type="Duality.Components.Physics.CircleShapeInfo" id="567613984">
                  <density dataType="Float">1</density>
                  <friction dataType="Float">0.3</friction>
                  <parent dataType="ObjectRef">1478431435</parent>
                  <position dataType="Struct" type="OpenTK.Vector2">
                    <X dataType="Float">0</X>
                    <Y dataType="Float">0</Y>
                  </position>
                  <radius dataType="Float">61.5325127</radius>
                  <restitution dataType="Float">0.3</restitution>
                  <sensor dataType="Bool">false</sensor>
                </item>
              </_items>
          ...
          <item dataType="Struct" type="QuietWell.Player" id="3469013200">
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">2710622207</gameobj>
          </item>
        </_items>
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="1358795704" surrogate="true">
        <header />
        <body>
          <keys dataType="Array" type="System.Type[]" id="1224402071">
            <item dataType="ObjectRef">809826144</item>
            <item dataType="ObjectRef">928388430</item>
            <item dataType="ObjectRef">3731969610</item>
            <item dataType="ObjectRef">3076783358</item>
          </keys>
          <values dataType="Array" type="Duality.Component[]" id="3968803520">
            <item dataType="ObjectRef">775969843</item>
            <item dataType="ObjectRef">57821479</item>
            <item dataType="ObjectRef">1478431435</item>
            <item dataType="ObjectRef">3469013200</item>
          </values>
        </body>
      </compMap>
      <compTransform dataType="ObjectRef">775969843</compTransform>
      <identifier dataType="Struct" type="System.Guid" surrogate="true">
        <header>
          <data dataType="Array" type="System.Byte[]" id="317802549">YoO2VCZgzUyqPpXBlcPXUA==</data>
        </header>
        <body />
      </identifier>
      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
      <name dataType="String">Taylor</name>
      <parent />
      <prefabLink />
    </item>
  </serializeObj>
